...
import com.morningstar.lab.service.SmallWorldNetworkService;
...
public class LabController {
    ...
    public void sendToAll(ChatMessage chatMessage, Principal principal) {
        ...
        messagingTemplate.convertAndSend("/topic/lab.chat.all", chatMessage);
    }
    ...
    public void sendToUser(ChatMessage chatMessage) {
        messagingTemplate.convertAndSend("/queue/lab.chat." + chatMessage.getReceiverId(), chatMessage);
    }
