...
public abstract class CommonDataInitializer {
    ...
    public void initializeData() {
        System.out.println(ansi().fg(GREEN).a("初始化权限相关表...").reset());
        initializePerm();
        System.out.println(ansi().fg(GREEN).a("初始化账号相关表...").reset());
        initializeAccount();
        System.out.println(ansi().fg(GREEN).a("初始化Kill应用...").reset());
        initializeKill();
        System.out.println(ansi().fg(GREEN).a("初始化Blog应用...").reset());
        initializeBlog();
    }
}
