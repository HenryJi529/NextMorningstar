...
public class CommentController {
    ...
    public R<PageResult<CommentDetail>> getCommentDetailByArticleId(@PathVariable("id") long articleId, @RequestParam("pageNum") int pageNum, @RequestParam("pageSize") int pageSize){
        return commentService.getCommentDetailByArticleId(articleId, pageNum, pageSize);
    }
