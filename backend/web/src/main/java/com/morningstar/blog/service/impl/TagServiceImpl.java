...
public class TagServiceImpl implements TagService {
    ...
    private void updateRelatedArticle(Integer tagId, String oldTagName, String newTagName){
    ...
    public R<Object> deleteTagById(Integer id) {
        ...
        updateRelatedArticle(id, oldTagName, "");
    ...
    public R<Object> updateTagById(UpdateTagRequestVo vo) {
        ...
        updateRelatedArticle(vo.getId(), oldTagName, vo.getName());
