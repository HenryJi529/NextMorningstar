...
import com.morningstar.blog.converter.TagConverter;
...
public class TagServiceImpl implements TagService {
    ...
    public Integer createTag(CreateTagRequestVo vo) {
        ...
        try {
            ...
            throw new BaseException(ResponseCode.BLOG_TAG_NAME_ALREADY_EXISTS, vo.getName());
        }
        return tag.getId();
    }
    ...
    public Tag getTagById(Integer id) {
        ...
        if (dbTag == null) {
            throw new BaseException(ResponseCode.BLOG_TAG_NOT_FOUND, id);
        }
        return dbTag;
    }
    ...
    public void updateTagById(UpdateTagRequestVo vo) {
        ...
        Tag dbTag = tagConverter.updateTagRequestVoToTag(vo);
        int count = tagMapper.updateById(dbTag);
        if (count != 1) {
            throw new BaseException(ResponseCode.BLOG_TAG_UPDATE_FAILED, dbTag.getId());
        }
