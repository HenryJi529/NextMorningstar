...
public class CategoryController {
    ...
    @DeleteMapping("/{id}")
    @PreAuthorize("hasAuthority('blog:category:manage')")
    public R<Object> deleteCategoryById(@PathVariable Integer id) {
    ...
    @PatchMapping("/{id}")
    @PreAuthorize("hasAuthority('blog:category:manage')")
    public R<Object> updateCategoryById(@PathVariable Integer id, @Valid @RequestBody UpdateCategoryRequestVo vo) {
