...
public interface ArticleService {
    ...
    void recordArticleView(Long id);

    void syncArticleViewByArticleId(Long id, int newViews);
    ...
    String getArticleSummaryByArticleId(Long id);

    void refreshArticleSummary();
}
