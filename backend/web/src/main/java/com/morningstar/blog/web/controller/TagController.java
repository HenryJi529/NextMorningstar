...
public class TagController {
    ...
    @GetMapping("/{id}")
    public R<Tag> getTagById(@PathVariable Integer id) {
    ...
    @DeleteMapping("/{id}")
    @PreAuthorize("hasAuthority('blog:tag:manage')")
    public R<Object> deleteTagById(@PathVariable Integer id) {
    ...
    @PatchMapping("/{id}")
    @PreAuthorize("hasAuthority('blog:tag:manage')")
    public R<Object> updateTagById(@PathVariable Integer id, @Valid @RequestBody UpdateTagRequestVo vo) {
