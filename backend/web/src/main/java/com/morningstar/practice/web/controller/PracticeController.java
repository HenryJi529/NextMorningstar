...
public class PracticeController {
    ...
    public R<List<Person>> findActorsByName(@RequestParam("name") String name){
    ...
    public R<GraphData> findShortestPathBetweenTwoActors(@RequestParam("person1Id") Long person1Id, @RequestParam("person2Id") Long person2Id) {
