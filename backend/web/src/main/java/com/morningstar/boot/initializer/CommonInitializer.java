...
import com.morningstar.system.dao.mapper.*;
...
import com.morningstar.system.pojo.po.RolePermission;
import com.morningstar.system.pojo.po.User;
import com.morningstar.system.properties.AccountProperties;
import com.morningstar.system.properties.PermProperties;
    ...
    protected void initializeAccount() {
        ...
        for (User user : accountProperties.getUser()) {
            if (userMapper.selectByUsername(user.getUsername()) == null) {
                User dbUser = systemFakeUtil.fakeUser();
