...
public class CommonServiceImpl implements CommonService {
    ...
    public R<ImageCaptchaResponseVo> getImageCaptcha() {
        ...
        // 组装响应数据
        ImageCaptchaResponseVo imageCaptchaResponseVo = ImageCaptchaResponseVo.builder().sessionId(sessionId).imageData("data:image/png;base64," + captcha.getImageBase64()).build();
        // 设置响应数据格式
        return R.ok(imageCaptchaResponseVo);
    }
    ...
    @Override
    public R<String> getQrcode(String data) {
        return R.ok(qrcodeUtil.generateAsBase64(data));
    }

    @Override
    public R<Object> getEmailCaptcha(String email) {
