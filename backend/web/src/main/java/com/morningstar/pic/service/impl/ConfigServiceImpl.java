...
public class ConfigServiceImpl implements ConfigService {
    ...
    public void validateGithubPat(String pat) {
        try {
            ...
            throw new BaseException(ResponseCode.PIC_GITHUB_PAT_INVALID);
        }
        // 判断仓库是否存在
        try {
            // 如果存在，判断能否修改目标仓库
            ...
            try {
                ...
                throw new BaseException(ResponseCode.PIC_GITHUB_REPO_ACCESS_DENIED, ImageLinkGenerator.repoName);
            }
