...
public class SkillPool {
    private static final String packagePath = SkillPool.class.getPackageName() + ".skill";
    private static final Map<Class<? extends Skill>, Skill> skills = new HashMap<>();
    static {
        Map<Class<?>, Object> instances = ClassUtil.loadInstancesByPackagePath(Skill.class, packagePath);
