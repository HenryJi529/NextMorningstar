...
import com.morningstar.kill.character.CharacterPool;
import com.morningstar.kill.deck.Deck;
import com.morningstar.kill.deck.DeckPool;
import com.morningstar.kill.exception.GameCreatedFailedException;
import com.morningstar.kill.exception.GameDeckNotSelectedException;
import com.morningstar.kill.exception.GameModeNotSatisfiedByTableMemberCountException;
import com.morningstar.kill.exception.GamePlayersNotInitializedException;
...
public abstract class Game {
    ...
    public void initializePlayers() {
        ...
        Character[] characters = selectCharacters();
        for (int i = 0; i < table.getMemberCount(); i++) {
            this.players[i] = new Player(table.getMembers()[i], characters[i]);
        }
    }
    ...
    public Character[] selectCharacters() {
        ...
        // 目前先实现随机分配不同的英雄
        return CharacterPool.getRandomNCharacters(table.getMemberCount());
    }
