...
public class HeroPool {
    private static final String packagePath = HeroPool.class.getPackageName() + ".hero";
    ...
    static {
        Map<Class<?>, Object> instances = ClassUtil.loadInstancesByPackagePath(Hero.class, packagePath);
