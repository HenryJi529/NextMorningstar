...
public class DeckPool {
    private static final String packagePath = DeckPool.class.getPackageName() + ".deck";
    private static final Map<Class<? extends Deck>, Deck> decks = new HashMap<>();
    static {
        Map<Class<?>, Object> instances = ClassUtil.loadInstancesByPackagePath(Deck.class, packagePath);
