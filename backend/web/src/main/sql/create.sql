...
(
    id          bigint,
    name        varchar(255) not null comment '参数名【采用命名空间格式，多级层级以点号(.)分隔】',
    value       json         not null,
    scope       varchar(20)  not null default 'INTERNAL' comment '作用域【PUBLIC:公开, INTERNAL:内部】',
...
(
    ...
    max_sonar_issues_per_run int          not null,
    max_ai_issues_per_run    int          not null,
    create_time              datetime,
    update_time              datetime,
