package com.morningstar.lab.core;
...
public class PathTest {
    ...
    public void testResource() throws IOException {
        ...
        byte[] content = Objects.requireNonNull(this.getClass().getResourceAsStream("/image/test.jpg")).readAllBytes();
        assert Math.round(content.length / 1024.0) == 27;
    }
