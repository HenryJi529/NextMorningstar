...
public class PoiTest {
    ...
    public void testWrite() {
        try (XSSFWorkbook workbook = new XSSFWorkbook()) {
            ...
            workbook.write(new FileOutputStream("temp/poi_test1.xlsx"));
    ...
    public void testWriteWithTemplate() {
        try (InputStream template = PoiTest.class.getClassLoader().getResourceAsStream("poi_template.xlsx")){
            ...
            workbook.write(new FileOutputStream("temp/poi_test2.xlsx"));
        } catch (IOException e) {
    ...
    public void testRead() {
        try (XSSFWorkbook workbook = new XSSFWorkbook("temp/poi_test1.xlsx")){
            XSSFSheet sheet = workbook.getSheetAt(0);
