...
public class EasyExcelTest {
    ...
    public void testRead() {
        ...
        EasyExcel.read(getClass().getResourceAsStream("/excel/easyexcel_read.xlsx"), FillData.class, new AnalysisEventListener<FillData>() {
            @Override
    ...
    public void testWriteWithTemplate1() throws URISyntaxException {
        ...
        EasyExcel.write("temp/easyexcel_writeWithTemplate1.xlsx").withTemplate(template).sheet().doFill(FillData.builder().name("张三").number(5.2).build());
    }
