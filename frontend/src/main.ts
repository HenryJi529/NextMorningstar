...
library.add(
    fasAngleLeft, fasAngleRight, fasAngleUp, fasArrowDown19, fasArrowDown91, fasArrowRight, fasAt,
    fasBars, fasBell, fasBookOpen, fasBriefcase,
    fasCircleMinus, fasCirclePlus, fasClipboard, fasClipboardCheck, fasCode, fasCompass, fasCopyright,
    ...
    fasTag, fasThumbsDown, fasThumbsUp, fasTrophy,
