...
library.add(
    ...
    fasCircleCheck, fasCircleDown, fasCircleExclamation, fasCircleInfo, fasCircleMinus, fasCirclePlus, fasCircleQuestion, fasCircleXmark, fasClipboard, fasClipboardCheck, fasCode, fasCompass, fasCopyright,
