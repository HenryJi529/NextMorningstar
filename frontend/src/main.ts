...
import {
    ...
    faTrash as fasTrash, faCircleXmark as fasCircleXmark, faShareNodes as fasShareNodes
} from "@fortawesome/free-solid-svg-icons";
import { faLightbulb as farLightbulb, faCompass as farCompass } from "@fortawesome/free-regular-svg-icons";
import { faGithub as fabGithub, faSearchengin as fabSearchengin, faBlackTie as fabBlackTie, faMarkdown as fabMarkdown } from "@fortawesome/free-brands-svg-icons";
library.add(
    ...
    fasCircleMinus, fasCirclePlus, fasCircleQuestion, fasCircleXmark, fasClipboard, fasClipboardCheck, fasCode, fasCompass, fasCopyright,
