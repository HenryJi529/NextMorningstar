...
export const getUsage = () => {
    return axios({
        url: '/pic/resource/usage',
        method: 'get',
    });
};

const API_CONFIG_GITHUB_PAT = '/pic/config/github-pat';
...
const API_CONFIG_COMPRESSION_QUALITY = '/pic/config/compression-quality';
...
export const getSecretKey = () => {
    return axios.get('/pic/config/secret-key');
};

export const getGithubAccount = () => {
    return axios({
        url: '/pic/config/github-account',
        method: 'get',
    });
};
...
const API_RESOURCE_IMAGE = '/pic/resource/image';
