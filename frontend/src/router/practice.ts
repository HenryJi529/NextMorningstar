...
export default [
    ...
    },
    {
        ...
        component: () => import("@/views/practice/DomSizePractice.vue"),
        meta: {
    ...
    },
    {
        ...
        children: [
            ...
            {
                path: 'post-message',
                name: 'practice-sub-iframe-communication-by-post-message',
            ...
            },
            {
                ...
                name: 'practice-sub-iframe-communication-by-message-channel',
            ...
            },
            {
                ...
                name: 'practice-sub-iframe-communication-by-broadcast-channel-a',
            ...
            },
            {
                ...
                name: 'practice-sub-iframe-communication-by-broadcast-channel-b',
    ...
    },
    {
        ...
        name: 'practice-data-visualization',
        component: () => import("@/views/practice/DataVisualizationPractice.vue"),
        meta: {
            verboseName: "数据可视化练习"
        }
    },
    {
        path: 'ui-component',
        name: 'practice-ui-component',
        component: () => import("@/views/practice/UIComponentPractice.vue"),
        meta: {
