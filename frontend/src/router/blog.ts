...
import CommentManageListView from "@/views/blog/manage/CommentManageListView.vue";
...
import CommentManageEditView from "@/views/blog/manage/CommentManageEditView.vue";
        ...
        children: [
            ...
            },
            {
                ...
                children: [
                    {
                        path: 'list',
                        name: 'blog-manage-comment-list',
                        component: CommentManageListView
                    },
                    {
                        path: 'edit/:id',
                        name: 'blog-manage-comment-edit',
                        component: CommentManageEditView
                    }
                ]
