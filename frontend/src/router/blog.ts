...
export default [
    ...
    },
    {
        ...
        meta: {
            requiresAuth: true,
            permissions: [
                Permission.BLOG_ARTICLE_MANAGE,
                Permission.BLOG_CATEGORY_MANAGE,
                Permission.BLOG_TAG_MANAGE,
            ],
        },
        children: [
            {
                path: 'article',
                meta: {
                    permissions: [Permission.BLOG_ARTICLE_MANAGE],
                },
                children: [
                    {
                        path: 'add',
            ...
            },
            {
                path: 'category',
                meta: {
                    permissions: [Permission.BLOG_CATEGORY_MANAGE],
                },
                children: [
                    {
                        path: 'add',
            ...
            },
            {
                path: 'tag',
                meta: {
                    permissions: [Permission.BLOG_TAG_MANAGE],
                },
                children: [
                    {
                        path: 'add',
