                    ...
                    <div class="py-4 flex flex-col space-y-4 flex-1">
                        <template v-for="articleDetail in pageResult.records">
                            <div class="overflow-hidden w-full">
                                ...
                                <div class="text-center flex justify-center items-center space-x-2 cursor-pointer mt-2" @click="router.push({name: 'blog-detail', params: {id: articleDetail.article.id}})">
