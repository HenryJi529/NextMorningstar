...
import type { TocTreeNode } from '@/composables/marked';
...
const jumpToAnchor = (anchor: string) => {
    ...
    setTimeout(() => {
        ...
        (document.getElementById(anchor) as HTMLElement).scrollIntoView({ behavior: 'auto' });
    }, 100);
};
</script>
            ...
            <details v-if="tocNode.children.length">
                <summary>
                    <span
                        ...
                        @click="jumpToAnchor(tocNode.anchor)"
