                ...
                <div :id="`comment-${comment.id}`" class="flex space-x-8 items-start pb-4">
                    ...
                    <div class="w-full overflow-hidden rounded-xl border-2">
                        ...
                        <div class="p-2">
                            ...
                            <div class="comment-body" v-html="DOMPurify.sanitize(commentBodyArray[index])"></div>
                        </div>
                    </div>
                </div>
            </template>
            ...
            <div class="flex-1 rounded-xl border-2 overflow-hidden">
                ...
                <div class="p-2">
                    ...
                    <div class="p-2 min-h-[11rem]">
                        ...
                        <div v-else>
                            <div class="comment-body" v-html="DOMPurify.sanitize(newCommentRenderResult)"></div>
                        </div>
                    </div>
                </div>
