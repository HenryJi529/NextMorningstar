...
import { MORNINGSTAR_GITHUB_LINK } from '@/constants/site';
import axios from '@/axios/index';
import type { R } from '@/types/common';
import { useUserStore } from '@/stores/users';
import { API_BLOG_ARTICLE_RANDOM, API_BLOG_FEED_ATOM, API_BLOG_FEED_RSS } from '@/constants/api';
import { getCurrentTheme, getDefaultTheme, getOppositeTheme, setTheme } from '@/utils/theme';
import ScrollToTop from '@/views/blog/components/ScrollToTop.vue';
import { useBlogStore } from '@/stores/blog';
import { getPermissions, hasAnyPermission } from '@/utils/permission';
...
const toggleTheme = () => {
    ...
    ls.set(LocalStorageKey.BLOG_PREFER_THEME, nextTheme, { ttl: 60 * 60 * 3 });
    window.clearInterval(themeTimer); // 一旦设置偏好主题，就不再自动更新
    setTheme(nextTheme);
...
onMounted(() => {
    const blog_prefer_theme = ls.get(LocalStorageKey.BLOG_PREFER_THEME);
                ...
                <div class="lg:flex lg:justify-between lg:items-center text-3xl lg:min-h-16 p-2">
                    ...
                    <div class="flex text-center items-center justify-center space-x-4 px-4">
                        ...
                        <div class="hover:animate-pulse" title="私信">
                            <div
                                class="cursor-pointer"
                                @click="router.push({ name: 'blog-contact' })">
                            ...
                            <div v-if="userStore.id" class="flex justify-center items-center">
                                <details class="dropdown dropdown-bottom dropdown-end">
                                    ...
                                    <ul class="nav-content">
                                        ...
                                        <li
                                            v-if="hasAnyPermission(getPermissions('blog-manage'))"
                                            class="nav-item">
                                            <div
                                                class="cursor-pointer"
                                                @click="
