...
<template>
    <div class="container mx-auto">
            ...
            <div class="modal" :class="{'modal-open': showServiceModal}">
                <div class="modal-box">
                    ...
                    <div class="py-4 text-2xl flex flex-col items-center justify-center">
                        ...
                        <div class="flex space-x-2 items-center">
                            <font-awesome-icon :icon="['fas', 'face-smile-wink']" />
                            <router-link to="/joke">神兔笑话</router-link>
                        </div>
                        <div class="flex space-x-2 items-center">
                            <font-awesome-icon :icon="['fas', 'rss']" />
                            <router-link to="/rss">聚合阅读</router-link>
                        </div>
                        <div class="flex space-x-2 items-center">
                            <font-awesome-icon :icon="['fas', 'share-nodes']" />
                            <router-link to="/share">链接分享</router-link>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="lg:flex lg:justify-between lg:items-center text-3xl lg:min-h-16 p-2">
            <div class="text-center p-2 hover:animate-pulse">
                <router-link to="/blog">
            ...
            <div class="flex text-center items-center justify-center space-x-4 px-4">
                ...
                <div title="RSS" class="cursor-pointer hover:animate-pulse">
                    <font-awesome-icon :icon="['fas', 'rss']" />
                </div>
                ...
                <div title="用户">
                    <div v-if="userStore.id" class="flex justify-center items-center">
                        <details class="dropdown dropdown-bottom dropdown-end">
                            <summary class="list-none w-12">
                                <img :src="userStore.avatarLink" alt="头像" class="rounded-full" />
                            </summary>
                            <ul class="nav-content">
                                <li class="nav-item">
                                    <div class="cursor-pointer" @click="router.push({name: 'blog-edit'})">编辑</div>
                                </li>
                                <li class="nav-item">
