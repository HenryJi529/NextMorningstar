...
const permissionsBlogEdit = router.getRoutes().filter(route => route.name === "blog-manage")[0].meta.permissions as string[];
                            ...
                            <div v-if="userStore.id" class="flex justify-center items-center">
                                <details class="dropdown dropdown-bottom dropdown-end">
                                    ...
                                    <ul class="nav-content">
                                        <li class="nav-item" v-if="hasAnyPermission(permissionsBlogEdit)">
