...
const permissionsBlogManage = router.getRoutes().filter(route => route.name === "blog-manage")[0].meta.permissions as string[];
                        ...
                        <div title="用户">
                            <div v-if="userStore.id" class="flex justify-center items-center">
                                <details class="dropdown dropdown-bottom dropdown-end">
                                    <summary class="list-none w-12 h-12 cursor-pointer">
                                        <img :src="userStore.avatarLink" alt="头像" class="rounded-full w-full h-full" />
                                    </summary>
                                    <ul class="nav-content">
                                        <li class="nav-item" v-if="hasAnyPermission(permissionsBlogManage)">
