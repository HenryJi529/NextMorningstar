...
const emailContactRequestVo = reactive<EmailContactRequestVo>({
    email: userStore.email !== null ? userStore.email : "",
    subject: "",
    content: "",
})
        ...
        <template #custom-main-part>
            <div class="p-4">
                ...
                <div class="flex flex-col space-y-3">
                    <input v-model="emailContactRequestVo.email" type="email" placeholder="邮箱" class="input input-ghost w-full rounded-xl" name="email" :disabled="userStore.email!=null" />
