...
import Dropdown from '@/views/lab/ui/Dropdown.vue';
import Tabs from '@/views/lab/ui/Tabs.vue';
import Carousel from '@/views/lab/ui/Carousel.vue';
import FileUploader from '@/views/lab/ui/FileUploader.vue';
import LinearProgressBar from '@/views/lab/ui/LinearProgressBar.vue';
import DatePicker from '@/views/lab/ui/DatePicker.vue';
import CustomTitle from '@/views/lab/ui/CustomTitle.vue';
import Modal from '@/views/lab/ui/Modal.vue';
import VirtualScroller from '@/views/lab/ui/VirtualScroller.vue';
...
const onFileUploaderUpdate = async (file: File) => {
    ...
    const response: R<object> = (await axios.post('/lab/upload-file-by-multipart-file', formData))
        .data;
