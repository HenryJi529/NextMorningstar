            ...
            <div class="overflow-scroll">
                <div class="flex items-center py-2">
                    ...
                    <div class="input input-bordered flex-1 flex items-center space-x-2 mx-4">
                        ...
                        <input type="text" name="nickname" id="nickname" placeholder="请输入昵称" v-model="nickname" class="w-full">
                ...
                <div class="flex items-center py-2">
                    ...
                    <div class="flex-1 p-2 flex items-center justify-center space-x-4 mx-4">
                        ...
                        <div class="flex-1">
                            <input type="file" class="file-input" name="avatar" id="avatar" accept="image/*" @change="readAvatar" />
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="flex-1 flex">
                        <div class="w-1/2 px-4">
                            <div class="input input-bordered flex items-center space-x-2">
                                ...
                                <input :type="hiddenNewPassword ?'password': 'text'" id="password" name="password" placeholder="请输入密码" v-model="updatePasswordRequestVo.newPassword" class="flex-1">
                    ...
                    <div class="flex-1 flex">
                        <div class="w-1/2 px-4">
                            <div class="input input-bordered flex items-center space-x-2">
                                ...
                                <input type="text" placeholder="请输入邮箱" name="email" id="email" v-model="updateEmailRequestVo.email" class="w-full">
                            </div>
                        </div>
                        <div class="w-1/2 px-4">
                            <email-captcha-field :data="updateEmailRequestVo" class="w-full" @error="handleSendEmailError"/>
                        </div>
                    </div>
                </div>
            </div>
