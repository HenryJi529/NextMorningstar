...
import ItemComponent from '@/views/nav/components/ItemComponent.vue';
...
import { PACE_JS_CSS, PACE_JS_JS } from '@/constants/external-cdn';
    ...
    <div>
        ...
        <div class="flex">
            <div
                ...
                <div class="text-3xl lg:text-4xl pt-4 lg:py-6 font-bold">晨星导航</div>
