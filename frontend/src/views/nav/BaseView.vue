    ...
    <div>
        <div class="sticky top-0 md:hidden w-full text-center">
            ...
            <nav class="flex justify-between w-full px-12">
                ...
                <router-link :to="{name: 'blog-contact'}" target="_blank" class="text-lg">
                    <font-awesome-icon :icon="['fas', 'at']" />
                </router-link>
            </nav>
        </div>
        <div class="flex">
            <div class="h-dvh hidden md:sticky md:top-0 md:min-w-[15rem] md:w-1/6 text-center md:flex flex-col justify-between">
                    ...
                    <ul class="py-2 flex flex-col justify-between items-center">
                        <template v-for="category in categories" :key="category.slug">
                            ...
                            <span class="text-xl lg:text-2xl font-bold hover:text-cyan-400">
                                <span class="inline-block w-10"><font-awesome-icon :icon="JSON.parse(category.icon)" /></span>
                                {{ category.name }}
                            </span>
                                </a>
                            </li>
