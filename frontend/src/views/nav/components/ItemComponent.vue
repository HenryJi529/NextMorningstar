    ...
    <div>
        ...
        <div v-if="item.isModal" :class="{ 'modal-open': modalOpen }" class="modal">
            <div class="modal-box">
                ...
                <ul class="pl-8 py-4">
                    <template v-for="entry in item.entries" :key="entry.name">
                        <li
                ...
                <div class="modal-action">
                    <button class="btn" @click="toggleModal">关闭</button>
                </div>
            </div>
        </div>
    </div>
...
.neumorphism-shadow {
    box-shadow:
        0.5rem 0.5rem 1rem #9d9d9d,
        -0.5rem -0.5rem 1rem #ffffff;
}

[data-theme='dark'] .neumorphism-shadow {
    box-shadow:
        0.5rem 0.5rem 1rem #191e24,
        -0.5rem -0.5rem 1rem #212830;
}
</style>
