...
const onboard = [
    ...
    {
        title: '到班来审 PR',
        desc: '每晚调度时段流水线自动开跑，早上到班在 Gitea 评审 PR，合并与否你说了算',
    },
];
</script>
    ...
    <section class="space-y-5 max-w-5xl mx-auto px-6">
        ...
        <div
            ...
            <p class="mt-3 text-sm text-slate-500 max-w-2xl mx-auto leading-relaxed">
                夜间由 AI 无人值守完成 扫描 → 修复 → 验证 →
                提交，早上到班，趁着进入工作状态前的工夫在 Gitea 上评审一个 PR。 AI
                拥有完整的执行权，但合并到主干的权力永远在人手里——AI 自主 + 人工门。
            </p>
        </div>
        ...
        <div class="rounded-xl border border-slate-200 bg-white shadow-sm p-6">
            ...
            <p class="text-xs text-slate-400 mb-5">任一身份被攻破，影响也仅限于各自的职责范围</p>
