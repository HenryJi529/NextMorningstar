...
const convertHtmlTableToExcelWorkbook = (tableElement: HTMLTableElement) => {
    ...
    // 获取未合并的表格
    const rawCells = _.cloneDeep(mergedCells);
    let row = 0;
...
<template>
    <div class="w-full">
        <table class="simple-table" id="selectedTable">
        ...
        <div class="flex justify-center items-center">
            <div class="m-10 flex justify-center items-center">
                <span><font-awesome-icon :icon="['fas', 'download']" class="text-5xl cursor-pointer mr-4" @click="exportTableMine"/>Mine</span>
            </div>
            <div class="m-10 flex justify-center items-center" @click="exportTableWithSheetJS">
                <span><font-awesome-icon :icon="['fas', 'download']" class="text-5xl cursor-pointer mr-4" @click="exportTableWithSheetJS"/>XLSX</span>
            </div>
        </div>
    </div>
</template>
