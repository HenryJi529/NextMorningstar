    ...
    <div class="w-full">
        ...
        <div class="flex justify-center items-center">
            <div class="m-10 flex justify-center items-center">
                <span @click="exportTableMine"><font-awesome-icon :icon="['fas', 'download']" class="text-5xl cursor-pointer mr-4"/>Mine</span>
            </div>
            <div class="m-10 flex justify-center items-center">
                <span @click="exportTableWithSheetJS"><font-awesome-icon :icon="['fas', 'download']" class="text-5xl cursor-pointer mr-4"/>XLSX</span>
            </div>
        </div>
    </div>
</template>
