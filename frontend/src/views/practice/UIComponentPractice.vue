...
const onFileUploaderUpdate = async (file: File) => {
    ...
    const response: R<object> = (await axios.post("/api/practice/upload-file-by-multipart-file", formData)).data;
    if (response.code <= 0) {
        alert(response.msg);
    } else {
...
<template>
    <base-layout>
        ...
        <div class="box">
            ...
            <div class="content">
                <file-uploader @update="onFileUploaderUpdate" :allowed-extensions="['.png', '.xls', '.xlsx', '.jpeg', '.jpg', '.pdf']">
        ...
        <div class="box">
            ...
            <div class="content">
                <linear-progress-bar active-color="#7a4678" default-color="#12121240" :precent="60" :radius="8" :height="20" :width="300" />
            </div>
        </div>
        <div class="box">
