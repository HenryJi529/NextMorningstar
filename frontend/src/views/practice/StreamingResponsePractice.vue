...
const slug = ref<"streaming-response-body"|"response-body-emitter"|"sse-emitter">("sse-emitter");
const endpoint = computed(() => "/api/practice/streaming-response/" + slug.value);
            ...
            <div class="mb-4">
                <div class="mb-4">
                    <a-radio-group v-model:value="slug" button-style="solid">
                        <a-radio-button value="streaming-response-body" :disabled="method === 'EventSource'">StreamingResponseBody</a-radio-button>
                        <a-radio-button value="response-body-emitter" :disabled="method === 'EventSource'">ResponseBodyEmitter</a-radio-button>
