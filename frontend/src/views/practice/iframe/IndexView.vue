     ...
     <base-layout>
         <div class="flex-1 w-full flex flex-col">
             ...
             <div class="flex-1 grid w-full grid-cols-2 gap-8">
                 <iframe ref="iframeByPostMessage" :src="router.resolve({name: 'practice-sub-iframe-communication-by-post-message'}).href" class="w-full h-full"></iframe>
                 <iframe ref="iframeByMessageChannel" :src="router.resolve({name: 'practice-sub-iframe-communication-by-message-channel'}).href" class="w-full h-full"></iframe>
                 <iframe :src="router.resolve({name: 'practice-sub-iframe-communication-by-broadcast-channel-a'}).href" class="w-full h-full"></iframe>
                 <iframe :src="router.resolve({name: 'practice-sub-iframe-communication-by-broadcast-channel-b'}).href" class="w-full h-full"></iframe>
             </div>
         </div>
     </base-layout>
</template>
