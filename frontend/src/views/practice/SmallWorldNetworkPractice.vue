...
const fetchPersonList = (name: string) => {
    return new Promise(resolve => {
        axios.get(`/api/practice/small-world-network/find-persons-by-name?name=${name}`).then(res=>{
...
const search = () => {
    ...
    axios({
        method: 'get',
        url: '/api/practice/small-world-network/find-shortest-path-between-two-persons',
        params: {
