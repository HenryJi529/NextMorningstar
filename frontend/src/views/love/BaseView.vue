...
import ImageBoard from '@/views/love/components/ImageBoard.vue';
...
<template>
    <div class="flex flex-col justify-between items-center w-screen h-page">
        <github-corner />
        <header
            class="animate__animated animate__fadeIn animate__slow pt-6 flex space-x-2 pb-2 items-center">
