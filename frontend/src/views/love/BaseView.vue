...
<template>
    <div class="flex flex-col justify-between items-center w-screen h-page">
        <github-corner/>
        <header class="animate__animated animate__fadeIn animate__slow text-3xl pt-6 flex space-x-2 pb-2">
            <a href="https://www.koalastothemax.com/" target="_blank">
                <font-awesome-icon :icon="['fas', 'copyright']"/>
            </a>
            <span class="text-pink-300 uppercase font-family-song">谨以此页献给欢欢</span>
        </header>
