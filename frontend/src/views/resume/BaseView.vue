...
<template>
    ...
    <div
        id="page"
        ref="page"
        class="box-border px-8 py-12 mx-auto font-family-song"
        data-theme="light">
            ...
            <div class="flex-1">
                <div class="flex flex-col">
                    <div class="flex items-center px-8 space-x-32 font-family-kai">
                        ...
                        <div class="text-2xl text-gray-700">求职意向: Web全栈开发</div>
                    </div>
                    <div class="pt-4 px-8 grid grid-cols-2 gap-y-2 gap-x-0 text-lg">
                        ...
                        <div>
                            <span>电子邮箱: </span>
                            <a v-if="isAdmin" href="mailto:jeep.jipu@outlook.com"
                                >jeep.jipu@outlook.com</a
                            >
        ...
        <div class="section">
            ...
            <div class="items">
                <div class="item">
                    ...
                    <div class="pl-8">
                        <div>
                            <span class="font-bold">主要工作：</span>
                            <ol class="ml-8 list-disc">
                                <li>
                                    前端:
                                    采用Vue3与TypeScript构建SPA，并结合TailwindCSS和DaisyUI美化页面样式
                                </li>
                                <li>
                                    后端: 基于Spring构建RESTful
                                    API，使用RabbitMQ作为消息队列，使用WebSocket实现部分通信
                                </li>
                                <li>
                                    运维:
                                    使用Docker与Fabric将项目部署于腾讯云，并通过GithubAction实现持续集成
                                </li>
                            </ol>
                        </div>
                        <div>
                            <span class="font-bold">项目成果：</span
                            >开发并部署了一系列Web应用程序，包括技术博客、开发者导航、在线简历、爱の相册等。
                        </div>
                    </div>
                </div>
                <div class="item">
                ...
                <div class="item">
                    ...
                    <div class="pl-8">
                        <div>
                            ...
                            <ol class="ml-8 list-disc">
                                <li>
                                    从用户注册时提供的Personal Access
                                    Token获取用户在Github中的相关信息
                                </li>
                                <li>
                                    将图片的上传与更新转换为Git仓库中commit的提交，响应的文件路径通过jsDelivr封装，无缝提供CDN支持
                                </li>
                                <li>
                                    实现图片压缩功能，支持自定义压缩质量，默认采用WebP格式，兼容JPEG格式作为备选方案
                                </li>
                                <li>
                                    提供Web界面管理图片资源，通过缓存每日图片列表与按响应时间选择CDN等方法提升访问速度
                                </li>
                        ...
                        <div>
                            <span class="font-bold">项目成果：</span
                            >实现了图床服务Web端的搭建，并提供了相关的API，可以为用户提供简便、专业且零成本的图床服务。
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="section">
            ...
            <ul class="list-disc ml-12">
                <li>
                    ...
                    蓝桥杯国赛Java研究生组优秀奖 蓝桥杯省赛Java研究生组一等奖
                    本科生学术科技论坛特等奖 美国大学生数学竞赛S奖
                </li>
                <li>
        ...
        <div class="section">
            ...
            <ul class="list-disc ml-12">
                ...
                <li>
                    ...
                    <span class="font-family-code">
                        PyTorch, Graph Neural Networks, Vision Transformer, Deep Reinforcement
                        Learning
                    </span>
                </li>
                <li>
