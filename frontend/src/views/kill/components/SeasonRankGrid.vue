...
import { GameMode, GameModeInfoMap } from '@/libs/kill';
import { onMounted, ref } from 'vue';
import axios from '@/axios';
import { API_KILL_RANK_SEASON } from '@/constants/api';
...
onMounted(async () => {
    const response: R<SeasonRank> = (await axios.get(API_KILL_RANK_SEASON)).data;
