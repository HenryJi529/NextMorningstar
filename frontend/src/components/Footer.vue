...
<template>
    <div>
        <div class="text-center pb-2">
            <div id="running_span">
                不温不火运行: {{ runningTime.dayNum }} 天 {{ runningTime.hourNum }} 小时
                {{ runningTime.minuteNum }} 分钟 {{ runningTime.secondNum }} 秒
            </div>
            <div id="copyright">
                <span
                    >© 2022
                    <a
                        class="font-bold font-family-lora"
                        href="https://linktr.ee/Henry529"
                        target="_blank"
                        >Henry Ji</a
                    >
                </span>
                ...
                <span
                    >License:
                    <a class="font-bold" href="https://www.gnu.org/licenses/agpl-3.0.en.html"
                        >AGPLv3</a
                    ></span
                >
                <span class="brightness-0"> / </span>
                <span
                    >Powered by <a class="font-bold" href="https://spring.io/">Spring</a> &
                    <a class="font-bold" href="https://cn.vuejs.org/">Vue</a></span
                >
            </div>
        </div>
    </div>
