...
<template>
    <article>
        ...
        <div class="fixed w-screen h-screen top-0 left-0 z-10 bg-gray-800/90 flex items-center justify-center" v-show="isImageModalOpen">
            ...
            <img :src="selectedImageLink" alt="大图" class=""/>
        </div>
