                    ...
                    <div class="w-full overflow-hidden rounded-xl border-2">
                        <div class="flex justify-between bg-blue-50 dark:bg-gray-700 p-2">
                            ...
                            <div class="flex items-center space-x-2">
                                ...
                                <div class="flex items-center space-x-1 cursor-pointer" @click="newCommentParentId = comment.id">
        ...
        <div class="flex space-x-8 items-start">
            ...
            <div class="flex-1 rounded-xl border-2 overflow-hidden">
                <div class="flex bg-slate-100 dark:bg-slate-600 space-x-1 rounded-t-xl p-2">
                    <div class="py-2 px-3 cursor-pointer rounded-xl" :class="{'bg-blue-200': isEdit, 'dark:bg-gray-700': isEdit}" @click="isEdit = !isEdit">编写</div>
                    <div class="py-2 px-3 cursor-pointer rounded-xl" :class="{'bg-blue-200': !isEdit, 'dark:bg-gray-700': !isEdit}" @click="isEdit = !isEdit">预览</div>
                </div>
                <div class="p-2">
                ...
                <div class="flex justify-end p-2 pt-0">
                    <div class="btn" v-if="userStore.id" @click="createNewComment">评论</div>
...
.comment-body{
    ...
    ::v-deep(.katex:has(math[display="block"])) {
        @apply text-2xl block py-3 overflow-x-scroll;
    }
    ::v-deep(p){
        @apply mb-4;
    }
