        ...
        <table class="w-full border-8 border-color rounded-xl border-solid border-separate border-spacing-0">
            ...
            <tr class="flex">
                ...
                <template v-for="(itemConfig, ind) in config.itemConfigs">
                    <th class="relative" :data-col="ind+1"
                        :class="[{'text-center': itemConfig.center, 'text-left': !itemConfig.center}, 'flex', 'items-center', 'justify-center', itemConfig.width]">
            ...
            <template v-for="item in sortedItems">
                <tr class="flex">
                    ...
                    <template v-for="(itemConfig, ind) in config.itemConfigs">
                        <td :class="[itemConfig.width, 'flex', 'items-center', 'flex-nowrap']" :data-col="ind+1">
