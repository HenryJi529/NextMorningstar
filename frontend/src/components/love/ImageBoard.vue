...
<template>
    <div class="mx-auto">
        <div v-if="isDone">
            <img :alt="lovePhotoData.photoName" :src="lovePhotoData.base64String" class="rounded-3xl"/>
        </div>
        <svg v-else ref="svg" :height="boardHeight" :width="boardWidth" xmlns="http://www.w3.org/2000/svg">
        </svg>
    </div>
</template>
