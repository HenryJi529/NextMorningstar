...
import type {UserEditableInfo} from "@/types/auth";
...
<template>
    <div class="p-4">
        ...
        <div>
            ...
            <div class="flex items-center py-2">
                ...
                <div class="flex-1 flex">
                    <div class="input input-bordered flex-1 flex items-center space-x-2 mx-4">
                        ...
                        <input :type="hiddenNewPassword ?'password': 'text'" name="password" placeholder="请输入密码" v-model="newPassword" class="flex-1">
                    ...
                    <div class="input input-bordered flex-1 flex items-center space-x-2 mx-4">
                        <font-awesome-icon :icon="['fas', 'key']" />
                        <input :type="hiddenConfirmPassword? 'password': 'text'" name="confirmPassword" placeholder="请确认密码" v-model="confirmPassword" class="flex-1">
            ...
            <button class="btn w-full" @click="updateSecurityInfo" :disabled="!(newPassword != '' && confirmPassword != '')">
                <span class="loading loading-dots loading-sm" v-if="isProcessing"></span>
