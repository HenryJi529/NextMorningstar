...
// PIC
export const API_PIC_CONFIG_GITHUB_PAT = "/api/pic/config/github-pat";
export const API_PIC_CONFIG_GITHUB_ACCOUNT = "/api/pic/config/github-account";
export const API_PIC_CONFIG_SECRET_KEY = "/api/pic/config/secret-key";
export const API_PIC_CONFIG_COMPRESSION_QUALITY = "/api/pic/config/compression-quality";
export const API_PIC_IMAGE = "/api/pic/resource/image";
export const API_PIC_IMAGE_SMALL = "/api/pic/resource/image/small";
export const API_PIC_IMAGE_LARGE = "/api/pic/resource/image/large";
export const API_PIC_USAGE = "/api/pic/resource/usage";
