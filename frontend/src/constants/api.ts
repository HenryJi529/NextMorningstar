...
export const API_BLOG_ARTICLE_SEARCH_REFRESH = '/blog/article/search/refresh';
export const API_BLOG_ARTICLE_SUMMARY = '/blog/article/summary/{id}';
export const API_BLOG_ARTICLE_SUMMARY_REFRESH = '/blog/article/summary/refresh';
