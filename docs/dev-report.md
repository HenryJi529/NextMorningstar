...
- **作品名称**：代码工坊
- **外网访问**：
    - 链接：[https://morningstar369.com/dev/about](https://morningstar369.com/dev/about)
    - 账号：SpiderMan / xxxxxxxx
- **项目定位**：AI 自动值守的代码质量优化流水线
- **宣传口号**：晚上 AI 修代码，早上你顺手审 PR
- **核心机制**：「AI 自主 + 人工门」夜间定时调度，AI 在沙盒中完成 扫描 → 修复 → 验证 → 提交 PR；人工评审决定是否合并

---

## 痛点问题与解决思路

### 痛点问题：技术债堆积 × 人力不足 × 算力错配
...
### 静态分析为什么选 SonarQube，而不是 PMD/SpotBugs？
